...
set_property PACKAGE_PIN W13 [get_ports {an_in[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[0]}]
set_property PACKAGE_PIN V2 [get_ports {an_in[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[1]}]
set_property PACKAGE_PIN T3 [get_ports {an_in[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {an_in[2]}]
set_property PACKAGE_PIN T2 [get_ports {an_in[3]}]					
